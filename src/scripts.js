...
(function() {
  ...
  function renderTotals(panel, vals, st) {
    ...
    const defenseRows = [
      ...
      statRow('Item CDR', mergeDisplay(base.itemCdr || 0, vals.itemCdr || 0, (vals.itemCdr || 0) - (base.itemCdr || 0), fmtPct), mergePositive && ((vals.itemCdr || 0) - (base.itemCdr || 0)) > 0 ? '' : bonusPct1((vals.itemCdr || 0) - (base.itemCdr || 0))),
    ].join('');
