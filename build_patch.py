...
W(hero_header("Bounty Hunter"))
W(ul_open())
W(li(facet_badge("bounty_hunter_mugging") + " Visual effect of gold flying towards Bounty Hunter is no longer visible to enemies if Bounty Hunter is invisible", t("NERF")))
W(ul_close())
W(ability("Shadow Walk", slug="bounty_hunter_wind_walk"))
W(ul_open())
...
W(ability("Viscous Nasal Goo", slug="bristleback_viscous_nasal_goo"))
W(ul_open())
W(li(facet_badge("bristleback_snot_rocket") + " " + "No longer has increased Armor Loss per stack", t("NERF")))
W(ul_close())
W(ability("Viscous Nasal Goo"))
W(ul_open())
...
W(li(facet_badge("hoodwink_hunter") + " " + "Active Attack Range decreased from 75/150/225/300 to 50/100/150/200", b([75, 150, 225, 300], [50, 100, 150, 200])))
W(ul_close())
W(ability("Mistwoods Wayfarer"))
W(ul_open())
...
W(ability("Adaptive Strike", slug="morphling_adaptive_strike_agi"))
W(ul_open())
W(li(facet_badge("morphling_str") + " " + "Stun is no longer exclusive to this facet", t("NERF")))
W(ul_close())
W(ability("Adaptive Strike", slug="morphling_adaptive_strike_agi"))
W(ul_open())
...
W(hero_header("Night Stalker"))
W(ul_open())
W(li(facet_badge("night_stalker_voidbringer") + " Heart of Darkness: No longer reduces Night Stalker's health regeneration by 20% during the day", t("NERF")))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
...
W(li(facet_badge("pugna_siphoning_ward") + " " + "Damage to Mana decreased from 30% to 20%", b(30, 20)))
W(ul_close())
W(subgroup("Talents"))
W(ul_open())
W(li("Level 15 Talent Health decreased from +350 to +300", b(350, 300)))
...
W(hero_header("Queen of Pain"))
W(ul_open())
W(li(facet_badge("queenofpain_facet_bondage") + " Returning Spell Damage decreased from 20% to 16%", b(20, 16)))
W(ul_close())
...
W(ul_open())
W(li(facet_badge("razor_thunderhead") + " " + "Storm Surge Cooldown Reduction decreased from 2.5s to 2s", b(2.5, 2, l=True)))
W(ul_close())
W(ability("Storm Surge"))
W(ul_open())
...
W(ul_open())
W(li(facet_badge("shadow_shaman_massive_serpent_ward") + " " + "Health and Bounty multiplier decreased from 10x to 9x", t("NERF"), extra=inline_note(" Hits to destroy decreased from 20 to 18, Gold Bounty decreased from 220–300 to 198–270, XP Bounty decreased from 310 to 279")))
W(ul_close())
W(ability("Shackles"))
W(ul_open())
...
W(li(facet_badge("venomancer_plague_carrier") + " " + "Septic Shock: Base Damage per Debuff decreased from 10% to 8%", b(10, 8)))
W(ul_close())
...
W(ability("Corrosive Skin", slug="viper_corrosive_skin"))
W(ul_open())
W(li(facet_badge("viper_caustic_bath") + " " + "Time to max effect increased from 4s to 5s", b(4, 5)))
W(ul_close())
