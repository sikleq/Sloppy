...
W(li("Aghanim's Scepter (level 4): 4100 Health, 8 Health Regen, 135–145 Damage, 9 Armor. Hurl Boulder: 200 Damage and 2s Stun Duration", t("NEW"), extra=inline_note("Other base stats are unchanged")))
W(ul_close())
...
W(li("Stats: 2500 Health, 8 Health Regen, 85–95 Damage", t("MISC"), extra=inline_note("Wind Walk: 320 Bonus Damage and 55% Bonus Movement Speed; Cyclone: 6s Hero Duration and 100 Damage on Landing")))
W(ul_close())
W(ability("Fire Brewling", slug="brewmaster_drunken_brawler_fire"))
W(ul_open())
W(li("Stats: 1750 Health, 8 Health Regen, 215–225 Damage, 24 Armor", t("MISC"), extra=inline_note("Permanent Immolation: 100 Damage per second")))
W(ul_close())
