...
W(item_header("Dagon"))
W(ul_open())
W(li("Recipe cost decreased from 1150 to 1100", b(1150, 1100, l=True), extra=inline_note("Total cost decreased from 3050/4200/5350/6500/7650g to 3000/4100/5200/6300/7400g")))
W(ul_close())
