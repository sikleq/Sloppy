...
def build():
    ...
    W(ul_open())
    W(li("Channeling the Twin Gate can now be interrupted by root", t("NERF")))
    W(ul_close())
    ...
    W(li("Frost no longer applies when attacking allies", t("DEL")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Disguise now has a fixed duration and is not affected by buff duration amplification", t("NERF")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("No longer applies when attacking allies", t("DEL")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Return Astral Spirit and Move Astral Spirit sub-abilities no longer break Elder Titan's invisibility when used", t("BUFF")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Can now be cast while rooted, but will not knock Sniper back if he is under the effect of root", t("BUFF")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Can now be interrupted by root", t("NERF")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Gate channeling can now be interrupted by root", t("NERF")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("No longer breaks Visage's invisibility when used to order Familiars to execute", t("BUFF")))
    W(ul_close())
