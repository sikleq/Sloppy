...
def build():
    ...
    W(li("Duration increased from 10s to 15s", b(10, 15)))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Draw Forth can no longer move the Harpoon caster if they are rooted/leashed/bound", t("NERF"), extra=inline_note("Still affects rooted/leashed/bound targets")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Base Agility increased from 20 to 22", b(20, 22), extra=inline_note("Damage at level 1 increased from 51-57 to 52-58")))
    W(ul_close())
    W(hero_header("Bane"))
    W(subgroup("Abilities"))
    W(ability("Brain Sap"))
    ...
    W(ul_open())
    W(li("Base Strength decreased from 25 to 24", b(25, 24), extra=inline_note("Damage at level 1 decreased from 50-54 to 49-53")))
    W(ul_close())
    W(subgroup("Abilities"))
    W(ability("Wild Axes"))
    W(ul_open())
    ...
    W(ul_open())
    W(li("Base Intelligence increased from 22 to 23", b(22, 23), extra=inline_note("Damage at level 1 increased from 53-59 to 54-60")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Base Strength increased from 22 to 23", b(22, 23), extra=inline_note("Damage at level 1 increased from 47-51 to 48-52")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Base Damage increased by 3", bstat_h("Hoodwink", "AttackDamageMin", "7.41b", 3), extra=note_box(hero="Hoodwink", field="AttackDamageMin", before_patch="7.41b", extra_note="Damage at level 1 unchanged at 47-54")))
    ...
    W(ul_open())
    W(li("Base Health Regen decreased by 0.25", bstat_h("Huskar", "StatusHealthRegen", "7.41b", -0.25), extra=note_box(hero="Huskar", field="StatusHealthRegen", before_patch="7.41b")))
    W(ul_close())
    ...
    W(subgroup("Talents"))
    W(ul_open())
    W(li("Level 20: +200 Catchy Lick Damage replaced with 2× Catchy Lick Charges", '<span class="badge swap" data-tag="swap">SWAP</span>'))
    W(li("Level 25: 2× Catchy Lick Charges replaced with 2× Frogstomp Stomps / Interval", '<span class="badge swap" data-tag="swap">SWAP</span>'))
    W(ul_close())
    W(hero_header("Lich"))
    W(subgroup("Abilities"))
    ...
    W(subgroup("Talents"))
    W(ul_open())
    W(li("Level 10: −25s Summon Spirit Bear Cooldown replaced with +5s True Form Duration", '<span class="badge swap" data-tag="swap">SWAP</span>'))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Base Agility decreased from 24 to 23", b(24, 23), extra=inline_note("Damage at level 1 decreased from 53-57 to 52-56")))
    W(ul_close())
    W(subgroup("Abilities"))
    ...
    W(ul_open())
    W(li("Base Agility increased from 21 to 22", b(21, 22), extra=inline_note("Damage at level 1 increased from 56-58 to 57-59")))
    W(ul_close())
    W(subgroup("Talents"))
    W(ul_open())
    ...
    W(subgroup("Talents"))
    W(ul_open())
    W(li("Level 15: −15s Dream Coil Cooldown replaced with +2% Puckish Health and Mana Restoration", '<span class="badge swap" data-tag="swap">SWAP</span>'))
    W(li("Level 25: Dream Coil Pierces Debuff Immunity replaced with −30s Dream Coil Cooldown", '<span class="badge swap" data-tag="swap">SWAP</span>'))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Base Agility increased from 26 to 29", b(26, 29), extra=inline_note("Damage at level 1 increased from 49-53 to 52-56")))
    W(ul_close())
    W(subgroup("Abilities"))
    ...
    W(li("Intelligence gain decreased from 3.0 to 2.7", b(3, 2.7), extra=inline_note("Damage gain per level decreased from 3.3 to 3.2 as a result")))
    W(ul_close())
    W(subgroup("Abilities"))
    ...
    W(subgroup("Talents"))
    W(ul_open())
    W(li("Level 10: +8 Strength replaced with +2 Tree Grab Attacks", '<span class="badge swap" data-tag="swap">SWAP</span>'))
    W(li("Level 15: −8% Grow Attack Speed Reduction replaced with +10 Strength", '<span class="badge swap" data-tag="swap">SWAP</span>'))
    W(ul_close())
    ...
    W(li("Level 20: +40% Snakebite Damage replaced with +100 Snakebite Initial Damage", '<span class="badge swap" data-tag="swap">SWAP</span>'))
    W(ul_close())
    W(hero_header("Viper"))
    W(subgroup("Abilities"))
