...
def build():
    ...
    W(ul_open())
    W(li("Eternal Chains radius increased from 275 to 325", b(275, 325), extra=inline_note("Effective radius increased from 350 to 400 due to item's built-in Area of Effect bonus — " + b(350, 400))))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Spellover now has a 0.1s internal cooldown", t("NERF"), extra=inline_note("Still can proc multiple times from a single instance of high damage")))
    W(li("Spellover damage threshold increased from 100 to 200", b(100, 200, l=True)))
    W(li("Spellover damage from hero targets increased from 40 to 80", b(40, 80), extra=inline_note("From 52 to 104 with Dormant Curio")))
    W(li("Spellover damage from creep targets increased from 15 to 30", b(15, 30), extra=inline_note("From 19.5 to 39 with Dormant Curio")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("False Flight duration increased from 5s to 6.5s", b(5, 6.5), extra=inline_note("From 6.5s to 8.45s with Dormant Curio")))
    W(ul_close())
    ...
    W(subgroup("Talents"))
    W(ul_open())
    W(li("Level 10 Talent +1 Acid Spray Armor Reduction replaced with +1% Corrosive Weaponry Slow / Damage Reduction Per Stack", t("SWAP")))
    W(li("Level 15 Talent +1% Corrosive Weaponry Slow / Damage Reduction Per Stack replaced with +1 Acid Spray Armor Reduction", t("SWAP")))
    W(ul_close())
    ...
    W(li("Level 20 Talent +200 Spark Wraith Damage replaced with +30s Spark Wraith Duration", t("SWAP")))
    W(li("Level 25 Talent +30s Spark Wraith Duration replaced with +240 Spark Wraith Damage", t("SWAP")))
    ...
    W(subgroup("Talents"))
    W(ul_open())
    W(li("Level 10 Talent Devour grants 15% Magic Resistance replaced with +10% Magic Resistance", t("SWAP")))
    W(li("Level 15 Talent +66 Damage replaced with +1.5% Infernal Blade Max HP As Damage", t("SWAP")))
    W(li("Level 20 Talent +2.5% Infernal Blade Max HP As Damage replaced with +66 Damage", t("SWAP")))
    W(ul_close())
    ...
    W(subgroup("Talents"))
    W(ul_open())
    W(li("Level 20 Talent +1 Orb Levels replaced with +50% Forged Spirit Armor Reduction", t("SWAP")))
    W(ul_close())
    ...
    W(subgroup("Talents"))
    W(ul_open())
    W(li("Level 10 Talent +40 Poof Damage replaced with -1.5s Earthbind Cooldown", t("SWAP")))
    W(li("Level 15 Talent -2.5s Earthbind Cooldown replaced with +40 Poof Damage", t("SWAP")))
