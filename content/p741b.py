...
def build():
    ...
    W(li("Hallowed now starts with all 3 charges when Consecrated Wraps is purchased or built", t("MISC"), extra=inline_note("Gaining max stacks requirement for the speedup buff is removed<br>Initial 3 charges don't provide the movement speed buff")))
