...
def build():
    ...
    W(ul_open())
    W(li("Recipe cost decreased from 600 to 400 " + b(600, 400, l=True) + ". Total cost unchanged at 3900g", t("BUFF")))
    W(ul_close())
    ...
    W(li("Recipe cost increased from 500 to 525 " + b(500, 525, l=True) + ". Total cost unchanged at 1625g", t("NERF")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Recipe cost increased from 800 to 850 " + b(800, 850, l=True), t("NERF"), extra=inline_note("Total cost unchanged at 1775g (due to Chainmail cost decrease)")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Recipe cost decreased from 450 to 300 " + b(450, 300, l=True) + ". Total cost unchanged at 3275g", t("BUFF")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Recipe cost increased from 250 to 300 " + b(250, 300, l=True), t("NERF"), extra=inline_note("Total cost unchanged at 2775g (due to Chainmail cost decrease)")))
    W(ul_close())
