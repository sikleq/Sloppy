...
def build():
    ...
    W(ul_open())
    W(li("After neutrals cast this ability, all copies of Arm of the Deep, Tendrils of the Deep, and Congregations of the Deep on other neutral Boglets, Croakers, and Ancient Croakers within 1200 range are put on 5s cooldown"))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Item moved back to Secret Shop from Miscellaneous Shop"))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Transmute no longer prevents camp-clearing Madstone Bundles from spawning if it was used on the last creep in neutral camp"))
    W(li("Getting guaranteed Madstone Bundle from Transmute used to prevent the camp-clearing bundle from spawning"))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Burn toggling no longer breaks invisibility nor stops channels"))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Can now be put on alt-cast to send the stroke straight"))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Aghanim's Scepter upgrade moved into a separate ability"))
    W(ul_close())
    ...
    W(ul_open())
    W(li("When targeting a tree, now always destroys the targeted tree and ends in the tree's position"))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Can now target Spirit Bear"))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Now considers Spirit Bear as a true hero for prioritization. Creep Heroes are now considered as secondary targets"))
    W(ul_close())
