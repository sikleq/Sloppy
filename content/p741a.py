...
def build():
    ...
    W(li("Portion of damage dealt on the edge of AoE decreased from 60% to 50%", b(60, 50), extra=inline_note("Minimum Damage decreased from 240/345/450 to 200/225/350 — " + b([240, 345, 450], [200, 225, 350]))))
    W(ul_close())
    W(subgroup("Talents"))
    W(ul_open())
