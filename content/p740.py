...
def build():
    ...
    W(ul_open())
    W(li("No longer has separate damage bonus, uses Tree Grab's value instead", t("MISC"), extra=inline_note("Bonus damage rescaled from 20 to 10/20/30/40 — " + b(20, [10, 20, 30, 40]))))
    W(ul_close())
