...
def build():
    ...
    W(ul_open())
    W(li("No longer has double duration against creeps", t("DEL")))
    W(li("Now deals double damage to creeps", t("NEW")))
    W(ul_close())
    ...
    W(subgroup("Camps"))
    W(ul_open())
    W(li("The Large camp nearest to Tier 3 towers where the streams used to start has been demoted to a 'medium' camp", t("NERF")))
    ...
    W(li("Large camps nearest to Wisdom Shrines have been moved slightly back towards the bases", t("MISC")))
    W(li("The Large camp in the 'triangle' has been demoted to a 'medium' camp", t("NERF")))
    W(ul_close())
    W(subgroup("Watchers"))
    W(ul_open())
    ...
    W(li("Nullifier's Nullify will dispel Cyclone off the target immediately if Cyclone was cast on a unit already affected by the Nullify debuff", t("NEW"), extra=inline_note(_cyclone_proj_note)))
    ...
    W(ul_open())
    W(li("Now upgrades with each subsequent drop", t("NEW"), extra=inline_note("Effect radius rescaled from 650 to 600/900/1200 — " + b(650, [600, 900, 1200]) + "<br>Hits to kill increased from 6 to 6/8/10 — " + b(6, [6, 8, 10]))))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Recipe cost increased from 350 to 450 " + b(350, 450, l=True), t("NERF"), extra=inline_note("Total cost unchanged at 2150 due to Shadow Amulet cost decrease")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Recipe cost increased from 800 to 1340 " + b(800, 1340, l=True), t("NERF"), extra=inline_note("Total cost unchanged at 2250 due to Iron Branch cost increase")))
    ...
    W(ul_open())
    W(li("Recipe cost increased from 700 to 800 " + b(700, 800, l=True), t("NERF"), extra=inline_note("Total cost unchanged at 3725 due to Ring of Tarrasque cost decrease")))
    W(ul_close())
    ...
    W(properties_change(
        ...
        new=[("",    "+12 Health Regen", b(18, 12)),
             ("",    "+6 Mana Regen",    b(8, 6))]))
    W(ul_open())
    W(li("Recipe cost increased from 200 to 1600 " + b(200, 1600, l=True), t("NERF"), extra=inline_note("Total cost unchanged at 5000 due to Ring of Tarrasque and Tiara of Selemene cost decrease")))
    W(ul_close())
    W(item_header("Revenant's Brooch"))
    W(ul_open())
    W(li("Recipe cost increased from 600 to 650 " + b(600, 650, l=True), t("NERF"), extra=inline_note("Total cost unchanged at 3300 due to Voodoo Mask cost decrease")))
    W(ul_close())
    W(item_header("Scythe of Vyse"))
    W(ul_open())
    W(li("Recipe cost increased from 600 to 700 " + b(600, 700, l=True), t("NERF"), extra=inline_note("Total cost unchanged at 5200 due to Tiara of Selemene cost decrease")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Soul Release charge gain radius increased from 1400 to 1500", b(1400, 1500)))
    W(li("Soul Release charges can now be gained by both Urn of Shadows and Spirit Vessel from the same hero death", t("BUFF")))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Aghanim's Scepter effect moved to Aghanim's Shard", t("REWORK")))
    ...
    W(ul_open())
    W(li("After fetching an enemy, Spirit Bear will now have an attack command issued towards the target", t("QoL")))
    W(ul_close())
    W(subgroup("Talents"))
    W(ul_open())
    ...
    W(ul_open())
    W(li("No longer has separate damage bonus, uses Tree Grab's value instead", t("REWORK"), extra=inline_note("Bonus damage rescaled from 20 to 10/20/30/40 — " + b(20, [10, 20, 30, 40]))))
    W(ul_close())
    ...
    W(ul_open())
    W(li("Familiars now have their own ability to independently recall it to Visage", t("NEW"), extra=inline_note("The alt cast behavior on Visage is unchanged")))
