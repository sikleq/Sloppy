...
- **Правило:** в журнал попадают только **новые функции и страницы** (новая страница, новый режим, новый вид отображения). Мелкие правки, вычитка, перф, переименования — нет. Запись добавляется в том же коммите. Пишем лаконично, по-английски: заголовок = название функции или страницы, 1–3 коротких пункта о том, что она даёт. Без внутренних цифр вроде «234 entities».
