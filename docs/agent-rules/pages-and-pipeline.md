...
- Каждая иконка собрана из слоёв под будущую анимацию при наведении: у шлема качается плюмаж, перо пишет, столбики растут, в колбе поднимаются пузыри, кольца AoE расходятся, пересыпается песок, череп поднимается, мечи скрещиваются с бликом, из чашки поднимаются сердечки.
