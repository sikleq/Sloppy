...
FACETS = {
    ...
    # 7.38 — auto-registered by generate_patch_code_v2.py
    "bane_dream_stalker": ("Dream Stalker", "Gray0"),
    "bane_sleepwalk": ("Sleepwalk", "Purple1"),
    "crystal_maiden_glacial_guard": ("Glacial Guard", "Gray3"),
    "earthshaker_slugger": ("Slugger Facet", "Yellow1"),
    "morphling_agi": ("Ebb", "Green0"),
    "pudge_rotten_core": ("Rotten Core", "Green3"),
    "sven_heavy_plate": ("Heavy Plate", "Blue0"),
    "zuus_livewire": ("Livewire", "Blue1"),
    "zuus_divine_rampage": ("Divine Rampage", "Gray3"),
    "shadow_shaman_voodoo_hands": ("Chicken Fingers", "Yellow1"),
    "slardar_leg_day": ("Leg Day", "Red2"),
    "slardar_brineguard": ("Brineguard", "Purple1"),
    "necrolyte_rapid_decay": ("Rapid Decay", "Green3"),
    "queenofpain_selfdmg": ("Masochist", "Red0"),
    "skeleton_king_facet_cursed_blade": ("Spectral Blade", "Red0"),
    "death_prophet_ghosts": ("Spirit Collector", "Green1"),
    "phantom_assassin_methodical": ("Methodical", "Gray0"),
    "phantom_assassin_sweet_release": ("Sweet Release", "Red0"),
    "templar_assassin_hidden_reach": ("Hidden Reach", "Blue1"),
    "luna_moonshield": ("Moonshield", "Gray3"),
    "dragon_knight_corrosive_dragon": ("Corrosive Dragon", "Green0"),
    "dazzle_poison_bloom": ("Poison Bloom", "Purple0"),
    "rattletrap_hookup": ("Hookup", "Gray2"),
    "jakiro_twin_terror": ("Twin Terror", "Red0"),
    "chen_frog_convert": ("Marshmage Convert", "Blue3"),
    "doom_bringer_gluttony": ("Gluttony", "Red0"),
    "doom_bringer_impending_doom": ("Impending Doom", "Gray0"),
    "spirit_breaker_bulls_hit": ("Bull's Hit", "Blue2"),
    "obsidian_destroyer_obsidian_decimator": ("Obsidian Decimator", "Blue0"),
    "lycan_alpha_wolves": ("Alpha Wolves", "Green2"),
    "chaos_knight_facet_fundamental_forging": ("Fundamental Forging", "Yellow1"),
    "rubick_frugal_filch": ("Frugal Filch", "Purple2"),
    "nyx_assassin_burn_mana": ("Mana Burn", "Blue3"),
    "visage_faithful_followers": ("Faithful Followers", "Blue2"),
    "medusa_undulation": ("Undulation", "Red0"),
    "magnataur_eternal_empowerment": ("Eternal Empowerment", "Gray1"),
    "shredder_second_chakram": ("Twisted Chakram", "Red1"),
    "techies_backpack": ("Spoon's Stash", "Blue1"),
    "oracle_facet_dmg": ("Clairvoyant Curse", "Red2"),
    "winter_wyvern_winterproof": ("Winterproof", "Blue2"),
    "arc_warden_power_capture": ("Power Capture", "Yellow1"),
    "dark_willow_shattering_crown": ("Shattering Crown", "Green4"),
    "hoodwink_hipshot": ("Hipshot", "Green0"),
    "mars_victory_feast": ("Victory Feast", "Red2"),
    "dawnbreaker_hearthfire": ("Trailblazer", "Yellow1"),
}
