...
Usage:  python tools/fetch_skill_priority.py [days=120]   -> data/rules/ability_priority.json
"""
...
def main(days=120):
    ...
    url = "https://api.opendota.com/api/explorer?sql=" + urllib.parse.quote(SQL.format(days=int(days)))
    ...
    doc = {"_doc": __doc__.strip().split("\n\n")[0] + " See tools/fetch_skill_priority.py.",
           "source": "api.opendota.com/api/explorer (pro matches)", "window_days": int(days),
