# Auto-generated v2 scaffold for 7.38c
# Source: data/7.38c_datafeed.json
...
W(ul_open())
W(li("Earth Brewling's Debuff Immunity magic resistance increased from 50% to 80%", b(50, 80, l=True)))
